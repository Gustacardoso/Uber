...
public class UsuarioFirebase {
    ...
    public static Usuario getDadosUsuarioLogado(){ //metodo para recuperar os dados do  usuario qe esta  logado
    ...
    public static boolean atualizarNomeUsuario(String nome){
       try{
           FirebaseUser user = getUsuarioAtual(); //tudo  isso para recuperar o nome do  usuario atual
    ...
    public static void redirecionaUsuarioLogado(final Activity activity){
         ...
         if (user != null){
             DatabaseReference usuarioRef = ConfiguracaoFirebase.getFirabaseDataBase()
                     .child("usuario")
    ...
    public static void atualizarDadosLocalizacao(double lat, double lon){
        ...
        DatabaseReference localUsuario = ConfiguracaoFirebase.getFirabaseDataBase()
                .child("local_usuario");

        GeoFire geoFire = new GeoFire(localUsuario);
        //agora vamos salvar os dados da localização do usuario
